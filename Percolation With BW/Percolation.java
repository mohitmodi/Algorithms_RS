public class Percolation
{
     ...
     private WeightedQuickUnionUF wqufBW = null; // o check backwashing during checking isFull()
     private int N = 0;
     public Percolation(int size)              // create N-by-N grid, with all sites blocked
     {
         ...
         wqufBW = new WeightedQuickUnionUF(N*N + 2);
         /*for (int i = 1; i <= N; i++)
         {
             wquf.union(0,i);
         }
